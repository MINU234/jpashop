...
public class OrderServiceTest {
    ...
    public void 주문취소() throws Exception{
        ...
        assertEquals(OrderStatus.CANCEL,getOrder.getStatus(),"주문 취소는 CANCEL상태이다");
        assertEquals(10,item.getStockQuantity(),"주문이 취소된 상품은 그만큼 재고가 증가야해야 한다.");
